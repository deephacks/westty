...
@Singleton
class WesttyResteasyHandler extends WesttyHttpHandler {
    private static final Logger log = LoggerFactory.getLogger(WesttyResteasyHandler.class);
    ...
    @Inject
    public WesttyResteasyHandler(WesttyJaxrsApplication jaxrsApps) {
