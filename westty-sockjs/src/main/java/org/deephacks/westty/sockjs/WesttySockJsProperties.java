...
public class WesttySockJsProperties extends WesttyProperties {
    ...
    public WesttySockJsProperties() {
        WesttyProperties.setProperty(SOCKJS_HTTP_HOST, WesttyProperties.getPublicIp());
        WesttyProperties.setProperty(SOCKJS_HTTP_PORT, "8090");

        WesttyProperties.setProperty(SOCKJS_EVENTBUS_HOST, WesttyProperties.getPrivateIp());
        WesttyProperties.setProperty(SOCKJS_EVENTBUS_PORT, ""
                + DefaultEventBus.DEFAULT_CLUSTER_PORT);
    }
